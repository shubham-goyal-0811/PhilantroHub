            ...
            <div className="parentmain1 h-screen w-full bg-[#d2c9c9]">
                <div className="childmain1">
                    <div className="ngos flex justify-between">
                        <div className="cate flex flex-col h-full w-3/12 items-center text-nowrap bg-[#f2f0ef] rounded-3xl hover:scale-105 shadow-2xl shadow-stone-800 duration-200" style={{ padding: "1%", margin: "0.5%" }}>
                            ...
                            <div className="types flex flex-col text-center">
                                {ngoTypesArray.map((type, index) => (
                                    <span
                                        key={index}
                                        className={`text-xl cursor-pointer rounded-full ${selectedType === type ? "bg-gray-200 font-bold" : ""} hover:bg-[#d2c9c9] duration-500`}
                        ...
                        <div className="ngosdiv w-full h-full flex flex-col items-center" style={{ padding: "1%", margin: "0.5%" }}>
                            {filteredNgos.map((ngo, index) => (
                                <div className="ngospace w-full h-auto flex flex-col text-4xl justify-center bg-[#f2f0ef] rounded-3xl shadow-2xl shadow-stone-800" style={{ padding: "0.5%", margin: "0.5%" }} key={index}>
