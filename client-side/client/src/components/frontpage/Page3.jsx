            ...
            <div className="frontpage_main3 flex flex-col w-auto items-center">
                <div className="frontpage_part3 w-full">
                    <div className="questionPhilantro flex justify-center">
                        <div className="philantro text-4xl md:text-6xl font-bold">
                            <h1>Philantro Hub?</h1>
                        </div>
                    </div>
                    <div className="whatis flex flex-col items-center">
                        <div className="whatisphilantro text-2xl md:text-4xl font-semibold text-center">
                            <h1>What are we?</h1>
                        </div>
                        <div className="desc flex justify-center text-center w-11/12 md:w-6/12 text-lg md:text-2xl border-4">
                        ...
                        <div className="tbl2 flex flex-col w-full justify-between">
                            <div className="flex flex-col text-left benefits w-full h-full">
                                <div className="benefitsheading text-4xl md:text-6xl font-bold flex justify-center">
                                    <h1>Benefits</h1>
                                </div>
                                <ul className="benefitstbl2 relative">
                                    ...
                                    <li className="flex w-full" style={{ padding: '2%' }}>
                                        <div className="leftdiv01 flex flex-col items-start w-full md:w-6/12">
                                            <h1 className="font-bold text-2xl md:text-4xl">Comprehensive Directory:</h1>
                                            <p className="text-lg md:text-2xl">Access to a vast and well-organized directory of NGOs from around the world, making it easier to find organizations that align with your values and interests.</p>
                                        </div>
                                    </li>
                                    <li className="flex w-full" style={{ padding: '2%' }}>
                                        <div className="leftdiv02 flex flex-col items-start w-full md:w-6/12">
                                            <h1 className="font-bold text-2xl md:text-4xl">Simplified Donation Process:</h1>
                                            <p className="text-lg md:text-2xl">Streamlined tools and resources to make the donation process quick, easy, and secure, ensuring that your contributions reach the intended causes efficiently.</p>
                                        </div>
                                    </li>
                                    <li className="flex w-full" style={{ padding: '2%' }}>
                                        <div className="leftdiv03 flex flex-col items-start w-full md:w-6/12">
                                            <h1 className="font-bold text-2xl md:text-4xl">Verified NGOs:</h1>
                                            <p className="text-lg md:text-2xl">PhilanthroHub features vetted and credible NGOs, giving you peace of mind that your donations are going to legitimate and impactful organizations.</p>
                                        </div>
                                    </li>
                                    <li className="flex w-full" style={{ padding: '2%' }}>
                                        <div className="leftdiv4 flex flex-col items-start w-full md:w-6/12">
                                            <h1 className="font-bold text-2xl md:text-4xl">User-Friendly Interface:</h1>
                                            <p className="text-lg md:text-2xl">Contributing to causes you care about can provide a sense of satisfaction and purpose.</p>
                                        </div>
                                    </li>
                                    <li className="flex w-full" style={{ padding: '2%' }}>
                                        <div className="leftdiv5 flex flex-col items-start w-full md:w-6/12">
                                            <h1 className="font-bold text-2xl md:text-4xl">Tax Benefits:</h1>
                                            <p className="text-lg md:text-2xl">Designed with ease of use in mind, PhilanthroHub’s intuitive interface ensures a smooth and enjoyable experience for donors of all ages and tech-savviness levels.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div className="reviews w-full h-full flex flex-col text-right">
                                <div className="donorheading text-4xl md:text-6xl font-bold flex justify-center">
                                ...
                                <ul className="revitbl relative">
                                    ...
                                    {reviews.map((review, index) => (
                                        <li className={`review-item flex w-full justify-end ${index % 2 === 0 ? 'odd' : 'even'}`} style={{ padding: '2%' }} key={index}>
                                            <div className="flex flex-col justify-end w-full md:w-7/12">
                                                <h1 className="font-bold text-2xl md:text-4xl">{review.name}</h1>
                                                <p className='text-lg md:text-2xl'>{review.review}</p>
                                            </div>
                                        </li>
                                    ))}
                                </ul>
